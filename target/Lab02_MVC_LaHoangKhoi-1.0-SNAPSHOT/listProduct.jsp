            ...
            <table id="example" class=" table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><img src="/images/<%=rs.getString("pro_pic")%>" alt="" style=" width: 100px; height: 100px; "> </td>
                        <th><%=rs.getString("pro_des")%></th>
                        <td>
                            <a class="button1" href="/BookController/Edit/<%=rs.getInt("pro_id")%>">Edit</a>  <a class="button2" onclick="return confirm('Are you sure' + ' to delete ' + '<%=rs.getString("pro_id")%>');" href="/BookController/Delete/<%= rs.getInt("pro_id")%>">Delete</a>
                        </td>
                    </tr>
                    <%
                        }
